...
function initSetting() {
    ...
    if (cookie("specialMode") && cookie("specialMode").toString() == '1') {
    document.getElementById("specialMode").checked = true;
    url = "./static/image/ljxx.png";
}
    gameRestart();
}
...
function show_setting() {
    ...
    document.getElementById("specialMode").checked = (cookie("specialMode") && cookie("specialMode").toString() == '1');
